...
public class DiscountPolicyFactory {
    public DiscountPolicy create() {
        // --- 1. 기본 부품 정의 ---
        DiscountPolicy disabilityPolicy = new PercentDiscountPolicy(0.3, new DisabilityCondition());
        DiscountPolicy vipPolicy = new AmountDiscountPolicy(Money.wons(1000), new VipCondition());
        DiscountPolicy defaultOverlappedPolicy = new OverlappedDiscountPolicy(
                new PercentDiscountPolicy(0.1, new MovieDayCondition()),
